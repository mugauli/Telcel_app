 ...
 */
public abstract class List_adapted_Comunicados extends BaseAdapter {
    ...
    public List_adapted_Comunicados(Context contexto, int R_layout_IdView, ArrayList<?> entradas) {
        super();
