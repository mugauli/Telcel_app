 ...
 */
public abstract class List_adapted_Lanzamientos extends BaseAdapter {

    private ArrayList<?> entradas;
    private int R_layout_IdView;
    private Context context;

    public List_adapted_Lanzamientos(Context contexto, int R_layout_IdView, ArrayList<?> entradas) {
        super();
