...
public class activity_detalle_comunicados_imagen extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTracker.setScreenName("Comunicados - detalle");
        ...
        if(breadcrumComunicado != null) {
            ...
            breadcrumComunicado.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(activity_detalle_comunicados_imagen.this, ComunicacionInternaActivity.class);
    ...
    if(breadcrumComunicado != null)
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(activity_detalle_comunicados_imagen.this,ayuda.class);
...
//Toolbar Menu
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(activity_detalle_comunicados_imagen.this, MainActivity.class);
        ...
        imgButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(activity_detalle_comunicados_imagen.this, triviasActivity.class);
                startActivity(i);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent i = new Intent(activity_detalle_comunicados_imagen.this, ActualizarActivity.class);
            startActivity(i);

            // Handle the camera action
        } else if (id == R.id.nav_gallery) {
            Intent i = new Intent(activity_detalle_comunicados_imagen.this, pinActivity.class);
            startActivity(i);


        } else if (id == R.id.nav_slideshow) {
            Intent i = new Intent(activity_detalle_comunicados_imagen.this, preferencias.class);
            startActivity(i);
