...
public class activity_detalle_sva extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTracker.setScreenName("Servicio de Valor Agregado - detalle");
...
//Toolbar Menu
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(activity_detalle_sva.this,ayuda.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent i = new Intent(activity_detalle_sva.this, pinActivity.class);
            startActivity(i);
