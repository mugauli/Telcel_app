...
public class activity_detalle_noticia extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTracker.setScreenName("Noticias - detalle");
       ...
       /* breadcrumComunicado.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent intent = new Intent(activity_detalle_noticia.this,ComunicacionInternaActivity.class);
...
//Toolbar Menu
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(activity_detalle_noticia.this, MainActivity.class);
        ...
        imgButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(activity_detalle_noticia.this, triviasActivity.class);
                startActivity(i);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent i = new Intent(activity_detalle_noticia.this, pinActivity.class);
            startActivity(i);
