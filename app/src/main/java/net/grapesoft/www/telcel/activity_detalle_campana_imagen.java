...
public class activity_detalle_campana_imagen extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTracker.setScreenName("Campañas internas - detalle");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(activity_detalle_campana_imagen.this,ayuda.class);
...
//ToolBar Menu
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent i = new Intent(activity_detalle_campana_imagen.this, preferencias.class);
            startActivity(i);
